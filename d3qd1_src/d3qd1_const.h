...
#ifndef D3QD1_CONST_H_
#define D3QD1_CONST_H_
...
#define GEPS   1.0e-15 // geometrical precision,must be the same as gmsh -tol (tolerance) option
#define IEPS   1.0e-12 // epsilon for DE integration
#define DEPS   0.1     // D_epsilon ( domain division parameter )
#define CDFH   1.0e-3  // difference parameter H
...
// coefficient of boundary integral equation(BIEQ)
#define SW_BDR_BIEQ 0 // r-directional integration setting.  0: GLN order GL, 1: GHN order GL
#define SW_BDT_BIEQ 0 // theta-directional integration setting, 0: GHN order GL, 1: DE

// coefficient of derivative boundary integral equation(DBIEQ)
#define CBD_CDF    10.0  // cut off parameter for near-boundary
...
// for PARDISO
#define PARDISO_PREC 0   // 0:double precision complex, 1:single precision complex, reduce memory and more faster
